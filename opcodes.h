...
INST("LD D,0x%02X", 1, { undefined(); }, 8)
INST("RL A", 1, { undefined(); }, 8)
INST("JR 0x%02X", 1, { undefined(); }, 12)
INST("ADD HL,DE", 1, { undefined(); }, 8)
...
INST("LD B,C", 1, { undefined(); }, 4)
INST("LD B,D", 1, { undefined(); }, 4)
INST("LD B,E", 1, { undefined(); }, 4)
INST("LD B,H", 1, { undefined(); }, 4)
INST("LD B,L", 1, { undefined(); }, 4)
INST("LD B,(HL)", 1, { undefined(); }, 8)
INST("LD B,A", 1, { undefined(); }, 4)
INST("LD C,B", 1, { undefined(); }, 4)
INST("LD C,C", 1, { undefined(); }, 4)
INST("LD C,D", 1, { undefined(); }, 4)
INST("LD C,E", 1, { undefined(); }, 4)
INST("LD C,H", 1, { undefined(); }, 4)
INST("LD C,L", 1, { undefined(); }, 4)
INST("LD C,(HL)", 1, { undefined(); }, 8)
INST("LD C,A", 1, { undefined(); }, 4)
...
INST("LD E,(HL)", 1, { undefined(); }, 8)
INST("LD E,A", 1, { undefined(); }, 4)
...
INST("ADD A,B", 1, { undefined(); }, 4)
INST("ADD A,C", 1, { undefined(); }, 4)
INST("ADD A,D", 1, { undefined(); }, 4)
INST("ADD A,E", 1, { undefined(); }, 4)
INST("ADD A,H", 1, { undefined(); }, 4)
INST("ADD A,L", 1, { undefined(); }, 4)
INST("ADD A,(HL)", 1, { undefined(); }, 8)
INST("ADD A,A", 1, { undefined(); }, 4)
...
INST("AND B", 1, { undefined(); }, 4)
INST("AND C", 1, { undefined(); }, 4)
INST("AND D", 1, { undefined(); }, 4)
INST("AND E", 1, { undefined(); }, 4)
INST("AND H", 1, { undefined(); }, 4)
INST("AND L", 1, { undefined(); }, 4)
INST("AND (HL)", 1, { undefined(); }, 8)
INST("AND A", 1, { undefined(); }, 4)
INST("XOR B", 1, { xor (gb.b); }, 4)
INST("XOR C", 1, { xor (gb.c); }, 4)
INST("XOR D", 1, { xor (gb.d); }, 4)
INST("XOR E", 1, { xor (gb.e); }, 4)
INST("XOR H", 1, { xor (gb.h); }, 4)
INST("XOR L", 1, { xor (gb.l); }, 4)
INST("XOR (HL)", 1, { undefined(); }, 8)
INST("XOR A", 1, { xor (gb.a); }, 4)
INST("OR B", 1, { or (gb.b); }, 4)
INST("OR C", 1, { or (gb.c); }, 4)
INST("OR D", 1, { or (gb.d); }, 4)
INST("OR E", 1, { or (gb.e); }, 4)
INST("OR H", 1, { or (gb.h); }, 4)
INST("OR L", 1, { or (gb.l); }, 4)
INST("OR (HL)", 1, { undefined(); }, 8)
INST("OR A", 1, { or (gb.a); }, 4)
...
INST("XX", 1, { undefined(); }, 4)
INST("XX", 1, { undefined(); }, 4)
INST("CP 0x%02X", 2, { cp((u8)gb.nn); }, 8)
INST("RST 38", 1, { undefined(); }, 16)
