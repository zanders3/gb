...
INST("CPL", 1, { cpl(); }, 4)
INST("JR NC,0x%02X", 2, { if (!gb.flags.c) { gb.pc += (i8)gb.nn; } }, 12)
...
INST("SCF", 1, { scf(); }, 4)
INST("JR C,0x%02X", 2, { if (gb.flags.c) { gb.pc += (i16)gb.nn; } }, 12)
...
INST("JP NZ,0x%04X", 3, { if (!gb.flags.z) { gb.pc = gb.nn; } }, 16)
INST("JP %04X", 3, { gb.pc = gb.nn; }, 16)
INST("CALL NZ,0x%04X", 3, { if (!gb.flags.z) { call(gb.nn); } }, 24)
...
INST("RET NC", 1, { if (!gb.flags.c) { ret(); } }, 20)
INST("POP DE", 1, { pop16(gb.de); }, 12)
INST("JP NC,0x%04X", 3, { if (!gb.flags.c) { gb.pc = gb.nn; } }, 16)
INST("XX", 1, { xx(); }, 4)
INST("CALL NC,0x%04X", 3, { if (!gb.flags.c) { call(gb.nn); } }, 24)
INST("PUSH DE", 1, { push16(gb.de); }, 16)
INST("SUB A,0x%02X", 2, { sub8((u8)gb.nn); }, 8)
INST("RST 10", 1, { rst(0x10); }, 16)
INST("RET C", 1, { if (gb.flags.c) { ret(); } }, 20)
INST("RETI", 1, { ret(); gb.interruptsEnabled = true; }, 16)
INST("JP C,0x%04X", 3, { if (gb.flags.c) { gb.pc = gb.nn; } }, 16)
INST("XX", 1, { xx(); }, 4)
INST("CALL C,0x%04X", 3, { if (gb.flags.c) { call(gb.nn); } }, 24)
INST("XX", 1, { xx(); }, 4)
